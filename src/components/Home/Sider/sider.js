                    ...
                    <section className='burger-menu-container'>
                        <nav className='burger-menu-nav'>
                            <li className='burger-menu-nav__menu-element'>
                                <a href='#' className='burger-menu-nav__link'>ПАРКОВКА</a>
                            </li>
                            <li className='burger-menu-nav__menu-element'>
                                <a href='#' className='burger-menu-nav__link'>СТРАХОВКА</a>
                            </li>
                            <li className='burger-menu-nav__menu-element'>
                                <a href='#' className='burger-menu-nav__link'>БЕНЗИН</a>
                            </li>
                            <li className='burger-menu-nav__menu-element'>
                                <a href='#' className='burger-menu-nav__link'>ОБСЛУЖИВАНИЕ</a>
                            </li>
                        </nav>
                        <section className='burger-menu-icons'>
                            <a href='#' className='burger-menu-icons__item'>
                                <svg className='burger-menu-icons__logo' width="32" height="32" viewBox="0 0 32 32"
